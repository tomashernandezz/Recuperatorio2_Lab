	...
	if(listaPokemones != NULL)
		{
			...
			PokemonAEliminar = (sPokemon*)ll_get(listaPokemones,index);

			Pokemon_getNombre(PokemonAEliminar,nombrePokemon);
			...
			if(respuesta == 's')
			{
				Pokemon_delete(PokemonAEliminar);
